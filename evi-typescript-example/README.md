<div align="center">
  ...
  <h1>Live Presentation Coaching</h1>
  <p>
    <strong>The MVP for livepresentation coaching with Hume.ai's Empathic Voice Interface!</strong>
  </p>
</div>

## Overview

This project is a live presentation coaching that helps professionals and college students practice their presentation. It leverages Hume's [Empathic Voice Interface](https://hume.docs.buildwithfern.com/docs/empathic-voice-interface-evi/overview) using its Typescript SDK. The code is inspired by Hume's example available on Github.
...
Next you'll need to set your environment variables necessary for authentication. You'll need your API key and Secret key which are accessible from the portal. See our documentation on [getting your api keys](https://hume.docs.buildwithfern.com/docs/introduction/getting-your-api-key). --> In the future we'll create a login page for entering your API.
...
5. ^ We will add more instruction on the coaching flow very soon!
